...
class AqlossCoreWire implements BaseWire {
  AqlossCoreWire.fromExternalLibrary(ExternalLibrary lib);
}

@JS('wasm_bindgen')
external AqlossCoreWasmModule get wasmModule;

@JS()
@anonymous
extension type AqlossCoreWasmModule._(JSObject _) implements JSObject {}
