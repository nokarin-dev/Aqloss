...
class _MprisObject extends DBusObject {
  ...
  final void Function(String)? onLoopStatus;
  final void Function(bool)? onShuffle;
  ...
  Future<DBusMethodResponse> setProperty(
    ...
    if (interface == 'org.mpris.MediaPlayer2.Player') {
      ...
      if (name == 'LoopStatus') {
        ...
        _loopStatus = status;
        onLoopStatus?.call(status);
        await emitPropertiesChanged(
          'org.mpris.MediaPlayer2.Player',
          changedProperties: {'LoopStatus': DBusString(_loopStatus)},
        );
      ...
      if (name == 'Shuffle') {
        ...
        onShuffle?.call(_shuffle);
        await emitPropertiesChanged(
          'org.mpris.MediaPlayer2.Player',
          changedProperties: {'Shuffle': DBusBoolean(_shuffle)},
        );
        return DBusMethodSuccessResponse();
      }
    }
